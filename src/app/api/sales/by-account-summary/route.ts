...
import { getSalesByAccountSummary } from '@/lib/data/sales';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const cachedQuery = createCachedQuery(
      () => getSalesByAccountSummary({ start: startDate, end: endDate }, normalizedBranches),
      ['sales', 'by-account-summary-v1', startDate, endDate, ...normalizedBranches],
    ...
    logError(error, 'GET /api/sales/by-account-summary');
