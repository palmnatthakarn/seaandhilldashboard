...
import { getItemSuppliers } from '@/lib/data/purchase';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const cachedQuery = createCachedQuery(
      () => getItemSuppliers({ start: startDate, end: endDate }, itemCode, branches),
      ['purchase', 'suppliers-by-item', startDate, endDate, itemCode, ...branches],
    ...
    logError(error, 'GET /api/purchase/suppliers-by-item');
