...
import { getDistinctPurchaseItems } from '@/lib/data/purchase';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const cachedQuery = createCachedQuery(
      () => getDistinctPurchaseItems({ start: startDate, end: endDate }, branches),
      ['purchase', 'item-list', startDate, endDate, ...branches],
    ...
    logError(error, 'GET /api/purchase/item-list');
