...
import { getABCAnalysis } from '@/lib/data/inventory';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const cachedQuery = createCachedQuery(
      () => getABCAnalysis({ start: startDate, end: endDate }, branches),
      ['inventory', 'abc-analysis', startDate, endDate, ...branches],
    ...
    logError(error, 'GET /api/inventory/abc-analysis');
